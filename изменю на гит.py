...
class Snake():
    ...
    def snake_snake(self, score, food_pos, screen_width, screen_height):
    ...
    def check_obstacles(self, game_over, screen_width, screen_height): #врезание головы змеи
        if any((
